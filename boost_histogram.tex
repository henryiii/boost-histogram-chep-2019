...
On of the challanges unique to boost-histogram was the need for C++14 support by the compiler; the classic "ManyLinux1" wheels were not sufficient for compiling boost-histogram. The new ManyLinux2014 format was coming out when this was being developed, and is used, but the older ManyLinux1 specification is still in heavy use 
...
The wheel building system (and therefore boost-histogram) supports Python 2.7 and Python 3.5 through 3.8 on ManyLinux1 with 32-bit and 64-bit flavors, as well as ManyLinux2010 in 64-bit. It supports Python 2.7 and 3.6 through 3.8 on macOS 64-bit and Windows in 32-bit and 64-bit architectures. 
